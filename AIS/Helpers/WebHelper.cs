...
namespace AIS.Helpers
{
    ...
    public class WebHelper
    {
        ...
        public virtual string GetCurrentIpAddress()
        {
            ...
            {
                var value = _httpContext.Request.UserHostAddress;
        ...
        public virtual string ServerVariables(string name)
        {
            ...
            try
            {
                ...
                {
                    result = _httpContext.Request.ServerVariables["HTTP_HOST"];
                }
            }
            catch
            {
        ...
        public virtual string GetHostLocation()
        {
            bool useSsl = IsCurrentConnectionSecured();
            return GetHostLocation(useSsl);
        }
        ...
        //        if (!success)
        //        {
        //            throw new ReckomendException("reckomend needs to be restarted due to a configuration change, but was unable to do so." + Environment.NewLine +
