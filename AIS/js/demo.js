...
//default theme
 ...
 // $('a.basic').cluetip({sticky: true, closePosition: 'title', arrows: true,local:true,showTitle: false });
   //$('a.basic').cluetip({sticky: true, arrows: true,local:true, showTitle: false });
